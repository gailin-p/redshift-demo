...
CREATE TABLE "staging_songs" (
    ...
    "title" VARCHAR(200) NOT NULL DISTKEY, 
...
SELECT timestamp 'epoch' + ts * interval '1 second', userId, level, staging_songs.song_id, staging_songs.artist_id, sessionId, location, userAgent
...
SELECT staging_songs.artist_id, staging_songs.artist_name, staging_songs.artist_location, staging_songs.artist_latitude, staging_songs.artist_longitude
FROM songplay JOIN staging_songs ON songplay.artist_id = staging_songs.artist_id
""")

time_table_insert = ("""
INSERT INTO "times" (start_time, hour, day, week, month, year, weekday)
SELECT start_time, DATEPART(HOUR, start_time), DATEPART(DAY, start_time), DATEPART(WEEK, start_time), DATEPART(MONTH, start_time), DATEPART(YEAR, start_time), DATEPART(WEEKDAY, start_time)
FROM songplay 
""")
